...
value="pulse(-15m 15m 0 3m 3m 1m 20m)"}
...
+ v(x1.hyst1_hv)=0 v(x1.hyst0_hv)=0 v(x1.enb_hv)=0
...
*setscale time
*plot tran1.v(vout) tran2.v(vout) tran3.v(vout) tran4.v(vout) tran5.v(vout) tran6.v(vout) tran7.v(vout) tran8.v(vout) tran9.v(vout)
...
C {devices/vsource.sym} -760 90 0 0 {name=Vtrim1 value=1.8}
